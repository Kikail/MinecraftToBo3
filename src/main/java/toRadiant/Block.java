...
public class Block extends Brush{
    ...
    public String toString(){
        ...
        s += " "+bottom.toString() + " " + texture + " " + "-40 40 0 0 0 0 lightmap_gray 16384 16384 0 0 0 0\n";
        s += " "+top.toString() + " " + texture + " " + "-40 40 0 0 0 0 lightmap_gray 16384 16384 0 0 0 0\n";
        s += " "+front.toString() + " " + texture + " " + "-40 40 0 0 0 0 lightmap_gray 16384 16384 0 0 0 0\n";
        s += " "+back.toString() + " " + texture + " " + "-40 40 0 0 0 0 lightmap_gray 16384 16384 0 0 0 0\n";
        s += " "+left.toString() + " " + texture + " " + "-40 40 0 0 0 0 lightmap_gray 16384 16384 0 0 0 0\n";
        s += " "+right.toString() + " " + texture + " " + "-40 40 0 0 0 0 lightmap_gray 16384 16384 0 0 0 0\n";
        s += "}\n";
        return s;
    }
}
